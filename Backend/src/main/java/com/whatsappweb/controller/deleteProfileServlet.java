...
//deleteServlet
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = getServletContext().getRequestDispatcher("/afterlogin.jsp");
		rd.include(request, response);
		
		
		RequestDispatcher rd1 = getServletContext().getRequestDispatcher("/del.html");
		...
		/*
		 * out.println("<html><body><center><br><br>"); out.println("<table>");
		 * out.println("<th><tr><h2><center> Delete Profile</center></h2></tr></td>");
		 * out.println("<form>  ");
		 * out.println("<th><tr>Email    : <input type=email name=email value="+ws.
		 * getEmail()+" disabled><br><br></tr></td>"); out.
		 * println("<th><tr>Password : <input type=password name=password placeholder='Enter the password'><br><br></tr></td>"
